...
public struct BottomSheetModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(allowBackdropToClose: Bool, a11yLabel: String?, minimizable: Bool?, startMinimized: Bool?, styles: LayoutStyle<BottomSheetElements, ConditionalStyleTransition<BottomSheetTransitions, Predicates>>?, children: [Children]) {
