...
public struct DataImageCarouselModel<Predicates: Codable>: Codable {
	...
	public init(styles: LayoutStyle<DataImageCarouselElements, ConditionalStyleTransition<DataImageCarouselTransitions, Predicates>>?, imageKey: String, duration: Int32, a11yLabel: String?) {
		self.styles = styles
