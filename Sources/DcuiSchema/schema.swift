...
public struct BasicStateStylingBlock<StyleProperties: Codable>: Codable {
	...
	public init(default: StyleProperties, pressed: StyleProperties?, hovered: StyleProperties?, disabled: StyleProperties?) {
...
public struct CatalogDevicePayButtonModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<CatalogDevicePayButtonElements, ConditionalStyleTransition<CatalogDevicePayButtonTransitions, Predicates>>?, provider: PaymentProvider, validatorTriggerConfig: ValidationTriggerConfig?, children: [Children], customStateKey: String?) {
...
public struct CatalogDropdownElements: Codable {
	public let own: [BasicStateStylingBlock<CatalogDropdownStyles>]
	public let dropDownListItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?
	public let dropDownSelectedItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?
	public let dropDownDisabledItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?
	public let dropDownListContainer: [BasicStateStylingBlock<CatalogDropdownStyles>]?

	public init(own: [BasicStateStylingBlock<CatalogDropdownStyles>], dropDownListItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?, dropDownSelectedItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?, dropDownDisabledItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?, dropDownListContainer: [BasicStateStylingBlock<CatalogDropdownStyles>]?) {
		self.own = own
		self.dropDownListItem = dropDownListItem
		self.dropDownSelectedItem = dropDownSelectedItem
		self.dropDownDisabledItem = dropDownDisabledItem
		self.dropDownListContainer = dropDownListContainer
	}
}

public struct ValidatorFieldConfig<Validators: Codable>: Codable {
	public let validationFieldKey: String
	public let validators: [Validators]
	public let validateOnChange: Bool?

	public init(validationFieldKey: String, validators: [Validators], validateOnChange: Bool?) {
...
public enum CatalogDropDownValidators: String, Codable {
	case required
}

public struct CatalogDropdownModel<NodeTemplate: Codable, Predicates: Codable>: Codable {
	public let openTemplate: NodeTemplate
	public let openDisabledTemplate: NodeTemplate
	public let closedTemplate: NodeTemplate
	public let closedDefaultTemplate: NodeTemplate
	public let requiredSelectionErrorTemplate: NodeTemplate?
	public let validatorFieldConfig: ValidatorFieldConfig<CatalogDropDownValidators>?
	public let a11yLabel: String?
	public let styles: LayoutStyle<CatalogDropdownElements, ConditionalStyleTransition<CatalogDropdownTransitions, Predicates>>?

	public init(openTemplate: NodeTemplate, openDisabledTemplate: NodeTemplate, closedTemplate: NodeTemplate, closedDefaultTemplate: NodeTemplate, requiredSelectionErrorTemplate: NodeTemplate?, validatorFieldConfig: ValidatorFieldConfig<CatalogDropDownValidators>?, a11yLabel: String?, styles: LayoutStyle<CatalogDropdownElements, ConditionalStyleTransition<CatalogDropdownTransitions, Predicates>>?) {
		self.openTemplate = openTemplate
		self.openDisabledTemplate = openDisabledTemplate
...
public struct CatalogDropdownTransitions: Codable {
	public let own: CatalogDropdownElements?

	public init(own: CatalogDropdownElements?) {
		self.own = own
	}
}
...
public struct CatalogImageGalleryElements: Codable {
	...
	public let mainImage: [BasicStateStylingBlock<DataImageStyles>]?
	public let thumbnailImage: [BasicStateStylingBlock<DataImageStyles>]?
	public let selectedThumbnailImage: [BasicStateStylingBlock<DataImageStyles>]?
	public let thumbnailList: [BasicStateStylingBlock<RowStyle>]?
	public let scrollIconButton: [BasicStateStylingBlock<RowStyle>]?
	...
	public init(own: [BasicStateStylingBlock<CatalogImageGalleryStyles>], mainImage: [BasicStateStylingBlock<DataImageStyles>]?, thumbnailImage: [BasicStateStylingBlock<DataImageStyles>]?, selectedThumbnailImage: [BasicStateStylingBlock<DataImageStyles>]?, thumbnailList: [BasicStateStylingBlock<RowStyle>]?, scrollIconButton: [BasicStateStylingBlock<RowStyle>]?, indicator: [BasicStateStylingBlock<CatalogImageGalleryIndicatorStyles>]?, activeIndicator: [BasicStateStylingBlock<CatalogImageGalleryIndicatorStyles>]?, seenIndicator: [BasicStateStylingBlock<CatalogImageGalleryIndicatorStyles>]?, progressIndicatorContainer: [BasicStateStylingBlock<CatalogImageGalleryIndicatorStyles>]?) {
		self.own = own
		self.mainImage = mainImage
		self.thumbnailImage = thumbnailImage
		self.selectedThumbnailImage = selectedThumbnailImage
		self.thumbnailList = thumbnailList
		self.scrollIconButton = scrollIconButton
...
public struct CatalogImageGalleryModel<Predicates: Codable>: Codable {
	...
	public let scrollGradientLength: Double?
	public let leftScrollIconTemplate: StaticImageModel<Predicates>?
	public let rightScrollIconTemplate: StaticImageModel<Predicates>?

	public init(styles: LayoutStyle<CatalogImageGalleryElements, ConditionalStyleTransition<CatalogImageGalleryTransitions, Predicates>>?, scrollGradientLength: Double?, leftScrollIconTemplate: StaticImageModel<Predicates>?, rightScrollIconTemplate: StaticImageModel<Predicates>?) {
		self.styles = styles
		self.scrollGradientLength = scrollGradientLength
		self.leftScrollIconTemplate = leftScrollIconTemplate
		self.rightScrollIconTemplate = rightScrollIconTemplate
	}
}

public struct CatalogImageGalleryTransitions: Codable {
	public let own: CatalogImageGalleryStyles?

	public init(own: CatalogImageGalleryStyles?) {
		self.own = own
	}
}
...
public struct DismissInstantPurchaseButtonStyles: Codable, Hashable {
	public let container: ContainerStylingProperties?
	public let background: BackgroundStylingProperties?
	public let border: BorderStylingProperties?
	public let dimension: DimensionStylingProperties?
...
public struct DismissInstantPurchaseButtonElements: Codable {
	public let own: [BasicStateStylingBlock<DismissInstantPurchaseButtonStyles>]

	public init(own: [BasicStateStylingBlock<DismissInstantPurchaseButtonStyles>]) {
		self.own = own
	}
}

public struct DismissInstantPurchaseButtonModel<Children: Codable, Predicates: Codable>: Codable {
	public let a11yLabel: String?
	public let styles: LayoutStyle<DismissInstantPurchaseButtonElements, ConditionalStyleTransition<DismissInstantPurchaseButtonTransitions, Predicates>>?
	public let children: [Children]

	public init(a11yLabel: String?, styles: LayoutStyle<DismissInstantPurchaseButtonElements, ConditionalStyleTransition<DismissInstantPurchaseButtonTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
...
public struct DismissInstantPurchaseButtonTransitions: Codable {
	public let own: DismissInstantPurchaseButtonStyles?

	public init(own: DismissInstantPurchaseButtonStyles?) {
		self.own = own
	}
}
...
public struct LayoutVariantDomainStatePredicate: Codable, Hashable {
	public let key: LayoutVariantDomainStateKey
	public let condition: OrderableWhenCondition
	public let value: Int32

	public init(key: LayoutVariantDomainStateKey, condition: OrderableWhenCondition, value: Int32) {
		self.key = key
		self.condition = condition
		self.value = value
	}
...
public indirect enum CatalogCombinedCollectionTemplateNodeChildren: Codable {
	...
	case catalogDropdown(CatalogDropdownModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>)
	case catalogImageGallery(CatalogImageGalleryModel<LayoutVariantWhenPredicate>)
	case dismissInstantPurchaseButton(DismissInstantPurchaseButtonModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>)
	...
	enum CodingKeys: String, CodingKey, Codable {
		case accessibilityGrouped = "AccessibilityGrouped",
			...
			dismissInstantPurchaseButton = "DismissInstantPurchaseButton"
	}
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .catalogDropdown:
				if let content = try? container.decode(CatalogDropdownModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>.self, forKey: .node) {
			...
			case .dismissInstantPurchaseButton:
				if let content = try? container.decode(DismissInstantPurchaseButtonModel<LayoutVariantNonInteractableChildren, LayoutVariantWhenPredicate>.self, forKey: .node) {
					self = .dismissInstantPurchaseButton(content)
					return
				}
			}
		}
	...
	public func encode(to encoder: Encoder) throws {
		...
		case .catalogImageGallery(let content):
			...
			try container.encode(content, forKey: .node)
		case .dismissInstantPurchaseButton(let content):
			try container.encode(CodingKeys.dismissInstantPurchaseButton, forKey: .type)
			try container.encode(content, forKey: .node)
		}
	}
}
...
public indirect enum LayoutSchemaModel: Codable {
	...
	case catalogDropdown(CatalogDropdownModel<LayoutSchemaModel, WhenPredicate>)
	case catalogImageGallery(CatalogImageGalleryModel<WhenPredicate>)
	case dismissInstantPurchaseButton(DismissInstantPurchaseButtonModel<LayoutSchemaModel, WhenPredicate>)
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .catalogDropdown:
				if let content = try? container.decode(CatalogDropdownModel<LayoutSchemaModel, WhenPredicate>.self, forKey: .node) {
					self = .catalogDropdown(content)
					return
				}
			case .catalogImageGallery:
			...
			case .dismissInstantPurchaseButton:
				if let content = try? container.decode(DismissInstantPurchaseButtonModel<LayoutSchemaModel, WhenPredicate>.self, forKey: .node) {
					self = .dismissInstantPurchaseButton(content)
					return
				}
			}
...
public enum LayoutVariantWhenPredicate: Codable, Hashable {
	...
	case domainState(LayoutVariantDomainStatePredicate)
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .domainState:
				if let content = try? container.decode(LayoutVariantDomainStatePredicate.self, forKey: .predicate) {
...
public indirect enum ModalChildren: Codable {
	...
	case dismissInstantPurchaseButton(DismissInstantPurchaseButtonModel<OuterLayoutNonInteractableChildren, OuterLayoutWhenPredicate>)
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .dismissInstantPurchaseButton:
				if let content = try? container.decode(DismissInstantPurchaseButtonModel<OuterLayoutNonInteractableChildren, OuterLayoutWhenPredicate>.self, forKey: .node) {
					self = .dismissInstantPurchaseButton(content)
					return
				}
			}
