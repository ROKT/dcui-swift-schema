...
public struct CatalogDropdownElements: Codable {
	...
	public init(own: [BasicStateStylingBlock<CatalogDropdownStyles>], dropDownListItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?, dropDownSelectedItem: [BasicStateStylingBlock<CatalogDropdownStyles>]?, dropDownListContainer: [BasicStateStylingBlock<CatalogDropdownStyles>]?) {
		self.own = own
...
public struct CatalogDropdownModel<NodeTemplate: Codable, Predicates: Codable>: Codable {
	...
	public init(openTemplate: NodeTemplate, closedTemplate: NodeTemplate, closedDefaultTemplate: NodeTemplate, requiredSelectionErrorTemplate: NodeTemplate?, validatorFieldConfig: ValidatorFieldConfig<CatalogDropDownValidators>?, a11yLabel: String?, styles: LayoutStyle<CatalogDropdownElements, ConditionalStyleTransition<CatalogDropdownTransitions, Predicates>>?) {
