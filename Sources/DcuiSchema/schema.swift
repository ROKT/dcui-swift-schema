...
public struct CatalogDevicePayButtonModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<CatalogDevicePayButtonElements, ConditionalStyleTransition<CatalogDevicePayButtonTransitions, Predicates>>?, provider: PaymentProvider, children: [Children]) {
...
public struct CatalogDropdownModel<NodeTemplate: Codable, Predicates: Codable>: Codable {
	...
	public init(openTemplate: NodeTemplate, closedTemplate: NodeTemplate, closedDefaultTemplate: NodeTemplate, requiredSelectionErrorTemplate: NodeTemplate?, a11yLabel: String?, styles: LayoutStyle<CatalogDropdownElements, ConditionalStyleTransition<CatalogDropdownTransitions, Predicates>>?) {
