...
public struct ContainerStylingProperties: Codable, Hashable {
	...
	public init(justifyContent: FlexJustification?, alignItems: FlexAlignment?, shadow: Shadow?, overflow: Overflow?, gap: Float?, blur: Float?, opacity: Float?) {
...
public struct BottomSheetModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(allowBackdropToClose: Bool, a11yLabel: String?, styles: LayoutStyle<BottomSheetElements, ConditionalStyleTransition<BottomSheetTransitions, Predicates>>?, children: [Children]) {
...
public struct CatalogResponseButtonModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11y_label: String?, styles: LayoutStyle<CatalogResponseButtonElements, ConditionalStyleTransition<CatalogResponseButtonTransitions, Predicates>>?, children: [Children]) {
		self.a11y_label = a11y_label
		self.styles = styles
		self.children = children
	}
}
...
public struct CloseButtonModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<CloseButtonElements, ConditionalStyleTransition<CloseButtonTransitions, Predicates>>?, children: [Children], dismissalMethod: String?) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
...
public struct ColumnModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ColumnElements, ConditionalStyleTransition<ColumnTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
...
public struct CreativeResponseModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, responseKey: String, styles: LayoutStyle<CreativeResponseElements, ConditionalStyleTransition<CreativeResponseTransitions, Predicates>>?, openLinks: LinkOpenTarget?, children: [Children]) {
		self.a11yLabel = a11yLabel
...
public struct InlineSpacingStylingProperties: Codable, Hashable {
	public let padding: String?
	public let margin: String?

	public init(padding: String?, margin: String?) {
		self.padding = padding
		self.margin = margin
	}
}

public struct InlineBasicTextStyle: Codable, Hashable {
	public let spacing: InlineSpacingStylingProperties?
	public let background: BackgroundStylingProperties?
	public let text: InlineTextStylingProperties?

	public init(spacing: InlineSpacingStylingProperties?, background: BackgroundStylingProperties?, text: InlineTextStylingProperties?) {
		self.spacing = spacing
		self.background = background
		self.text = text
	}
...
public struct InlineBasicTextElements: Codable {
	public let own: [BasicStateStylingBlock<InlineBasicTextStyle>]

	public init(own: [BasicStateStylingBlock<InlineBasicTextStyle>]) {
		self.own = own
	}
}

public struct InlineBasicTextModel<Predicates: Codable>: Codable {
	public let styles: LayoutStyle<InlineBasicTextElements, ConditionalStyleTransition<InlineBasicTextTransitions, Predicates>>?
	public let value: String

	public init(styles: LayoutStyle<InlineBasicTextElements, ConditionalStyleTransition<InlineBasicTextTransitions, Predicates>>?, value: String) {
		self.styles = styles
		self.value = value
	}
}

public struct InlineBasicTextTransitions: Codable, Hashable {
	public let own: InlineBasicTextStyle?

	public init(own: InlineBasicTextStyle?) {
		self.own = own
	}
}

public struct InlineContainerStylingProperties: Codable, Hashable {
	public let shadow: Shadow?
	public let blur: Float?
	public let opacity: Float?

	public init(shadow: Shadow?, blur: Float?, opacity: Float?) {
		self.shadow = shadow
		self.blur = blur
		self.opacity = opacity
	}
...
public struct InlineStaticLinkStyles: Codable, Hashable {
	public let container: InlineContainerStylingProperties?
	public let background: BackgroundStylingProperties?
	public let border: BorderStylingProperties?
	public let spacing: InlineSpacingStylingProperties?

	public init(container: InlineContainerStylingProperties?, background: BackgroundStylingProperties?, border: BorderStylingProperties?, spacing: InlineSpacingStylingProperties?) {
		self.container = container
		self.background = background
		self.border = border
		self.spacing = spacing
...
public struct InlineStaticLinkElements: Codable {
	public let own: [BasicStateStylingBlock<InlineStaticLinkStyles>]

	public init(own: [BasicStateStylingBlock<InlineStaticLinkStyles>]) {
		self.own = own
	}
}

public struct InlineStaticLinkModel<Children: Codable, Predicates: Codable>: Codable {
	public let a11yLabel: String?
	public let src: String
	public let open: LinkOpenTarget
	public let styles: LayoutStyle<InlineStaticLinkElements, ConditionalStyleTransition<InlineStaticLinkTransitions, Predicates>>?
	public let children: [Children]

	public init(a11yLabel: String?, src: String, open: LinkOpenTarget, styles: LayoutStyle<InlineStaticLinkElements, ConditionalStyleTransition<InlineStaticLinkTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.src = src
		self.open = open
		self.styles = styles
...
public struct InlineStaticLinkTransitions: Codable, Hashable {
	public let own: InlineStaticLinkStyles?

	public init(own: InlineStaticLinkStyles?) {
		self.own = own
	}
}

public struct InlineToggleButtonStateTriggerStyle: Codable, Hashable {
	public let container: InlineContainerStylingProperties?
	public let background: BackgroundStylingProperties?
	public let border: BorderStylingProperties?
	public let spacing: InlineSpacingStylingProperties?
...
public struct InlineToggleButtonStateTriggerElements: Codable {
	public let own: [BasicStateStylingBlock<InlineToggleButtonStateTriggerStyle>]

	public init(own: [BasicStateStylingBlock<InlineToggleButtonStateTriggerStyle>]) {
		self.own = own
	}
}

public struct InlineToggleButtonStateTriggerModel<Children: Codable, Predicates: Codable>: Codable {
	public let a11yLabel: String?
	public let styles: LayoutStyle<InlineToggleButtonStateTriggerElements, ConditionalStyleTransition<InlineToggleButtonStateTriggerTransitions, Predicates>>?
	public let children: [Children]
	public let customStateKey: String

	public init(a11yLabel: String?, styles: LayoutStyle<InlineToggleButtonStateTriggerElements, ConditionalStyleTransition<InlineToggleButtonStateTriggerTransitions, Predicates>>?, children: [Children], customStateKey: String) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
...
public struct InlineToggleButtonStateTriggerTransitions: Codable, Hashable {
	public let own: InlineToggleButtonStateTriggerStyle?

	public init(own: InlineToggleButtonStateTriggerStyle?) {
		self.own = own
	}
}
...
public struct OverlayModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(allowBackdropToClose: Bool, a11yLabel: String?, styles: LayoutStyle<OverlayElements, ConditionalStyleTransition<OverlayTransitions, Predicates>>?, children: [Children]) {
		self.allowBackdropToClose = allowBackdropToClose
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
...
public struct ProgressControlModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ProgressControlElements, ConditionalStyleTransition<ProgressControlTransitions, Predicates>>?, direction: ProgressionDirection, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
...
public struct RowModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<RowElements, ConditionalStyleTransition<RowTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
...
public struct ScrollableColumnModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ScrollableColumnElements, ConditionalStyleTransition<ScrollableColumnTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
...
public struct ScrollableRowModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ScrollableRowElements, ConditionalStyleTransition<ScrollableRowTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
...
public struct StaticLinkModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, src: String, open: LinkOpenTarget, styles: LayoutStyle<StaticLinkElements, ConditionalStyleTransition<StaticLinkTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.src = src
		self.open = open
		self.styles = styles
...
public struct ToggleButtonStateTriggerModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ToggleButtonStateTriggerElements, ConditionalStyleTransition<ToggleButtonStateTriggerTransitions, Predicates>>?, children: [Children], customStateKey: String) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
		self.customStateKey = customStateKey
...
public struct ZStackContainerStylingProperties: Codable, Hashable {
	...
	public init(justifyContent: FlexJustification?, alignItems: FlexAlignment?, shadow: Shadow?, overflow: Overflow?, blur: Float?, opacity: Float?) {
		self.justifyContent = justifyContent
		self.alignItems = alignItems
		self.shadow = shadow
		self.overflow = overflow
...
public struct ZStackModel<Children: Codable, Predicates: Codable>: Codable {
	...
	public init(a11yLabel: String?, styles: LayoutStyle<ZStackElements, ConditionalStyleTransition<ZStackTransitions, Predicates>>?, children: [Children]) {
		self.a11yLabel = a11yLabel
		self.styles = styles
		self.children = children
	}
