...
public struct ContainerStylingProperties: Codable, Hashable {
	...
	public init(justifyContent: FlexPosition?, alignItems: FlexPosition?, shadow: Shadow?, overflow: Overflow?, gap: Float?) {
...
public struct AccessibilityGroupedColumnStyle: Codable, Hashable {
...
public struct AccessibilityGroupedColumnElements: Codable {
	public let own: [BasicStateStylingBlock<AccessibilityGroupedColumnStyle>]

	public init(own: [BasicStateStylingBlock<AccessibilityGroupedColumnStyle>]) {
		self.own = own
	}
}
...
public struct AccessibilityGroupedColumnModel<T: Codable>: Codable {
	public let styles: LayoutStyle<AccessibilityGroupedColumnElements>?
	public let children: [T]

	public init(styles: LayoutStyle<AccessibilityGroupedColumnElements>?, children: [T]) {
		self.styles = styles
		self.children = children
	}
}

public struct AccessibilityGroupedRowStyle: Codable, Hashable {
	public let container: ContainerStylingProperties?
	public let background: BackgroundStylingProperties?
	public let border: BorderStylingProperties?
	public let dimension: DimensionStylingProperties?
...
public struct AccessibilityGroupedRowElements: Codable {
	public let own: [BasicStateStylingBlock<AccessibilityGroupedRowStyle>]

	public init(own: [BasicStateStylingBlock<AccessibilityGroupedRowStyle>]) {
		self.own = own
	}
}

public struct AccessibilityGroupedRowModel<T: Codable>: Codable {
	public let styles: LayoutStyle<AccessibilityGroupedRowElements>?
	public let children: [T]

	public init(styles: LayoutStyle<AccessibilityGroupedRowElements>?, children: [T]) {
		self.styles = styles
		self.children = children
	}
}
...
public struct DataImageModel: Codable {
	...
	public init(styles: LayoutStyle<DataImageElements>?, imageKey: String, isImportantForAccessibility: Bool?) {
		self.styles = styles
...
public struct GroupedDistributionModel: Codable {
	public let styles: LayoutStyle<GroupedDistributionElements>?
	public let settings: GroupedSettings

	public init(styles: LayoutStyle<GroupedDistributionElements>?, settings: GroupedSettings) {
		self.styles = styles
		self.settings = settings
	}
}
...
public struct ProgressControlModel<Children: Codable>: Codable {
	public let styles: LayoutStyle<ProgressControlElements>?
	public let direction: ProgressionDirection
	public let children: [Children]

	public init(styles: LayoutStyle<ProgressControlElements>?, direction: ProgressionDirection, children: [Children]) {
		self.styles = styles
...
public struct ProgressIndicatorModel: Codable {
	...
	public init(styles: LayoutStyle<ProgressIndicatorElements>?, indicator: String, settings: ProgressIndicatorSettings?, isImportantForAccessibility: Bool?) {
		self.styles = styles
		self.indicator = indicator
		self.settings = settings
		self.isImportantForAccessibility = isImportantForAccessibility
...
public struct StaticImageModel: Codable {
	...
	public init(styles: LayoutStyle<StaticImageElements>?, alt: String?, title: String?, url: StaticImageUrl, isImportantForAccessibility: Bool?) {
		self.styles = styles
		self.alt = alt
		self.title = title
		self.url = url
...
public indirect enum LayoutSchemaModel: Codable {
	...
	case accessibilityGroupedRow(AccessibilityGroupedRowModel<AccessibilityGroupedLayoutChildren>)
	case column(ColumnModel<LayoutSchemaModel>)
	case accessibilityGroupedColumn(AccessibilityGroupedColumnModel<AccessibilityGroupedLayoutChildren>)
	...
	enum CodingKeys: String, CodingKey, Codable {
		case row = "Row",
			accessibilityGroupedRow = "AccessibilityGroupedRow",
			column = "Column",
			accessibilityGroupedColumn = "AccessibilityGroupedColumn",
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .accessibilityGroupedRow:
				if let content = try? container.decode(AccessibilityGroupedRowModel<AccessibilityGroupedLayoutChildren>.self, forKey: .node) {
					self = .accessibilityGroupedRow(content)
					return
				}
			case .column:
			...
			case .accessibilityGroupedColumn:
				if let content = try? container.decode(AccessibilityGroupedColumnModel<AccessibilityGroupedLayoutChildren>.self, forKey: .node) {
					self = .accessibilityGroupedColumn(content)
					return
				}
			case .staticImage:
	...
	public func encode(to encoder: Encoder) throws {
		...
		case .accessibilityGroupedRow(let content):
			try container.encode(CodingKeys.accessibilityGroupedRow, forKey: .type)
			try container.encode(content, forKey: .node)
		case .column(let content):
			try container.encode(CodingKeys.column, forKey: .type)
			try container.encode(content, forKey: .node)
		case .accessibilityGroupedColumn(let content):
			try container.encode(CodingKeys.accessibilityGroupedColumn, forKey: .type)
			try container.encode(content, forKey: .node)
...
public indirect enum AccessibilityGroupedLayoutChildren: Codable {
	...
	case when(WhenModel<AccessibilityGroupedLayoutChildren>)
	case staticImage(StaticImageModel)
	case basicText(BasicTextModel)
	case dataImage(DataImageModel)
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .when:
				if let content = try? container.decode(WhenModel<AccessibilityGroupedLayoutChildren>.self, forKey: .node) {
					self = .when(content)
					return
				}
			case .staticImage:
