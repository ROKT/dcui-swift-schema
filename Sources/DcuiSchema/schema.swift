...
public struct TimerStateTriggerModel: Codable {
	public let customStateKey: String
	public let delay: Float?
	public let value: Float?

	public init(customStateKey: String, delay: Float?, value: Float?) {
...
public indirect enum CatalogStackedCollectionTemplateNodeChildren: Codable {
	...
	case timerStateTrigger(TimerStateTriggerModel)
	...
	enum CodingKeys: String, CodingKey, Codable {
		case accessibilityGrouped = "AccessibilityGrouped",
			...
			timerStateTrigger = "TimerStateTrigger",
	...
	public init(from decoder: Decoder) throws {
		...
		if let type = try? container.decode(CodingKeys.self, forKey: .type) {
			...
			case .timerStateTrigger:
				if let content = try? container.decode(TimerStateTriggerModel.self, forKey: .node) {
					self = .timerStateTrigger(content)
					return
				}
	...
	public func encode(to encoder: Encoder) throws {
		...
		case .staticLink(let content):
			...
			try container.encode(content, forKey: .node)
		case .timerStateTrigger(let content):
			try container.encode(CodingKeys.timerStateTrigger, forKey: .type)
			try container.encode(content, forKey: .node)
